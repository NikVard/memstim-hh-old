...
def cost_func(data, duration=1, fs=10000, areasizes={"EC":[10000, 1000], "DG":[10000, 100], "CA3":[1000, 100], "CA1":[10000, 1000]}, params_FR={"winsize":1e3, "overlap":0.5}, params_PSD={"winsize":1e3}, gains={"FR":1, "FR_mean":1, "FR_max":1, "PSD":1}):
...
if __name__ == "__main__":
    ...
    tdir = 'results/analysis/optimization_test/very_bad/data'
    ...
    J, vec = cost_func(data, duration, fs, params_FR=params_FR)
    ...
    with open('optimization_test.csv', 'w', encoding='UTF8', newline='') as fout:
