...
if __name__ == "__main__":
    ...
    # Load the data
    #------------------------
    dir_data = [os.path.join(parent_dir, 'results_cluster', 'results_noICAN_fig4_quantify', '10.0_nA', '0.00_1333.0_ms', '27-09-2022 18H07M53S', 'data'), os.path.join(parent_dir, 'results_cluster', 'results_ICAN_fig4_quantify', '10.0_nA', '0.00_1333.0_ms', '27-09-2022 18H42M54S', 'data')]
    ...
    dir_ICAN = os.path.join(dir_cluster, 'results_ICAN_fig4_quantify')
    dir_noICAN = os.path.join(dir_cluster, 'results_noICAN_fig4_quantify')
